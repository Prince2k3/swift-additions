...
extension UIViewController {
    @discardableResult
    func presentAlert(title: String, message: String, buttonTitles: [String] = ["OK"]) -> Guarantee<UIAlertAction> {
...
extension UIApplication {
    @discardableResult
    static func presentAlert(title: String, message: String, buttonTitles: [String] = ["OK"]) -> Guarantee<UIAlertAction> {
        return Guarantee { fulfill in
            guard
